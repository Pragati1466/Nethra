...
<details>
<summary>🎨 Modern Design System</summary>
...
<details>
<summary>🗺️ Interactive Maps</summary>

- MapLibre GL integration for city visualization
- Dynamic layer toggles (events, units, heatmaps)
- Impact radius visualization
- Diversion route rendering
- Real-time unit tracking
- H3 hex grid overlay for spatial analysis
...
<details>
<summary>📊 Risk Prediction Engine</summary>

- Historical incident analysis (8,173 records)
- Multi-factor risk scoring (crowd, duration, location, timing)
...
<details>
<summary>📈 Learning Dashboard</summary>
...
<details>
<summary>🔍 Explainability Layer</summary>

- Factor decomposition (why this risk score?)
- Similar historical outcomes
- Junction incident patterns
- Diversion rationale with pros/cons
...
<details>
<summary>🧠 AI Strategist</summary>

- Chat-based interface for scenario queries
- Context-aware responses
- Suggested questions
- Event citation and referencing
...
- Productive hours lost estimation
- Vehicle impact analysis
- Hospital and school facility impact
- Emergency access risk scoring
- Economic loss estimation (₹ lakhs)
- Demographic breakdown

</details>

<details>
<summary>🚦 Diversion Planning</summary>

- Traffic-aware route generation
- Capacity-based ranking
- ETA impact calculation
- Coverage analysis (junctions, corridors)
...
<details>
<summary>⚡ Live Operations Pulse</summary>

- Real-time corridor congestion monitoring
- Field unit tracking (patrols, officers, ambulances)
- Dynamic alert generation
- Live feed streaming
- Citywide KPI aggregation
- 2.5-second tick interval

</details>

<details>
<summary>🚨 Dynamic Alerts</summary>

- Corridor load surge detection
- Sensor cluster monitoring
- Unit arrival notifications
- AI strategist flagging
- TTL-based alert lifecycle

</details>

<details>
<summary>📡 Active Deployments</summary>

- Event status tracking (draft → planned → deployed → live → closed)
...
<details>
<summary>📊 Traffic Pulse</summary>

- Corridor load visualization
- Flow rate calculation
- Status classification (free, moderate, heavy, gridlock)
- Delta tracking (load changes)
- Historical comparison

</details>

<details>
<summary>🗺️ Digital Twin</summary>

- 168-hour week replay
- Time scrubber control
- H3 hex grid intensity visualization
- Event overlay
...
<details>
<summary>📈 Charts & Metrics</summary>
...
<details>
<summary>🎨 Color-Coded Risk Bands</summary>
...
<details>
<summary>🗂️ Panel System</summary>
...
graph TB
    subgraph "Frontend Layer"
        A[TanStack Start App] --> B[TanStack Router]
        B --> C[React Components]
        C --> D[UI Components<br/>Radix UI]
        C --> E[Nethra Components<br/>Domain-specific]
    end
    
    subgraph "State Management"
        F[TanStack Query] --> G[React Hooks]
        G --> H[usePulse Hook<br/>Live Operations]
        G --> I[useEvents Hook<br/>Event Store]
    end
    
    subgraph "Intelligence Layer"
        J[intel.ts<br/>Prediction Engine] --> K[predictImpact<br/>Risk Scoring]
        J --> L[explainEvent<br/>Explainability]
        J --> M[diversionRoutesFor<br/>Route Planning]
    end
    
    subgraph "Data Processing"
        N[impact.ts<br/>Citizen Impact] --> O[assessImpact<br/>Economic & Demographics]
        P[pulse.ts<br/>Live Simulation] --> Q[step Function<br/>2.5s Tick]
    end
    
    subgraph "Data Layer"
        R[incidents.json<br/>8,173 Records] --> S[H3 Hex Grid<br/>Spatial Index]
        R --> T[landmarks.ts<br/>Facilities]
        U[timefield.ts<br/>Temporal Model] --> V[168-Hour<br/>Intensity Curves]
    end
    
    subgraph "Visualization"
        W[MapLibre GL] --> X[CityMap Component]
        W --> Y[TwinMap Component]
        Z[Recharts] --> AA[Charts & Metrics]
    end
