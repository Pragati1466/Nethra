...
//#region node_modules/.nitro/vite/services/ssr/assets/osrm.functions-C_3slNqx.js
...
var getDiversionRoutes = createServerFn({ method: "POST" }).inputValidator((d) => d).handler(getDiversionRoutes_createServerFn_handler, async ({ data }) => {
